...
from tabla_general.models import Equipos, Jornadas, Cartas, Puntos_extra, Colores, Cartas_aux, jugadores_gol, Puntos_cartas
...
def jornadas(request):
    ...
    for n in range(len(Jugadores)):
        ...
        print(Jugadores[n], carta, carta_auxiliar, prediccion)
        puntos, puntos_extra, sec_colores = get_points(Resultados, Resultados_s, carta, prediccion, carta_auxiliar, Jugadores_con_gol)
